...
public class Drawer01Behavior : MonoBehaviour
{
    ...
    private void OpenDoor()
    {
        ...
        // Start a new coroutine to close the door after the delay
        autoCloseCoroutine = StartCoroutine(CloseDoorAfterDelay(50.0f));
    }
